...
The purpose of this project was to get a survey of some of the software and methods use in intelligent robotics. Things I aimed to learn about included ROS, Tensorflow, OpenCv, signal filtering, etc.
